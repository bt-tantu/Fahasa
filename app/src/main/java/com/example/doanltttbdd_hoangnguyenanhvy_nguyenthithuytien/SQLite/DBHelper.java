...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String nhapSp1 = "INSERT INTO tbsanpham (TENSP, LUONGTON, DONGIA, DVT, ANH, MALOAISP, MAKHO) VALUES " +
                " ('Túp lều bác Tom', 365, 78000, 'Quyển', 'tupleubactom','1', '1'), " +
                " ('Cây cam ngọt của tôi', 100, 108000, 'Quyển', 'caycamngotcuatoi', '1', '1'), " +
                " ('Tâm lý học - Phác họa chân dung kẻ phạm tội', 59, 145000, 'Quyển', 'tamlyhoc','1', '1'), " +
                " ('Nhà giả kim', 35, 79000, 'Quyển','nhagiakim', '1', '1'), " +
                " ('Những vị thần nước Mỹ', 505, 204000, 'Quyển', 'nhungvithannuocmy','1', '1'), " +
                " ('Thần thoại Bắc Âu', 235, 104000, 'Quyển','thanthoaibacau', '1', '1');";
        String nhapSp2 = "INSERT INTO tbsanpham (TENSP, LUONGTON, DONGIA, DVT, ANH, MALOAISP, MAKHO) VALUES " +
                " ('Birdmen - Tập 1', 69, 30000, 'Cuốn','birdman1', '2', '1'), " +
                " ('Birdmen - Tập 2', 485, 30000, 'Cuốn','birdman2', '2', '1'), " +
                " ('Look Back', 59, 35000, 'Cuốn', 'lookback','2', '1'), " +
                " ('Thị trấn vắng mình tôi - Tập 6', 95, 58000, 'Cuốn', 'thitranvangbongminhtoi6','2', '1'), " +
                " ('Chú thuật hồi chiến - Tập 8', 15, 24000, 'Cuốn', 'chuthuathoichien8','2', '1'), " +
                " ('Lớp học rùng rợn - Tập 3', 5, 30000, 'Cuốn', 'lophocrungron3','2', '1');";
        String nhapSp3 = "INSERT INTO tbsanpham (TENSP, LUONGTON, DONGIA, DVT, ANH, MALOAISP, MAKHO) VALUES " +
                " ('Sách giáo khoa bộ lớp 12 - Sách bài học (Bộ 14 cuốn)', 165, 180000, 'Bộ', 'sgk12baihoc','3', '1')," +
                " ('Sách giáo khoa bộ lớp 12 - Sách bài tập (Bộ 11 cuốn)', 665, 165000, 'Bộ','sgk12baitap', '3', '1')," +
                " ('Mĩ thuật 1 (Cánh diều) (2022)', 355, 13000, 'Quyển', 'mithuat1','3', '1')," +
                " ('Tự nhiên và xã hội 1 (Cánh diều) (2022)', 565, 27000, 'Quyển', 'tunhienvaxahoi1','3', '1')," +
                " ('Vở chính tả 1 (Kết nối)', 2, 14000, 'Quyển', 'vochinhta1','3', '1');";
        String nhapSp4 = "INSERT INTO tbsanpham (TENSP, LUONGTON, DONGIA, DVT, ANH, MALOAISP, MAKHO) VALUES " +
                " ('Lịch để bàn Teen Mini 2023', 400, 10000, 'Cái','lichdebanmini2023', '4', '1')," +
                " ('Ba lô bông hình Doraemon', 20, 249000, 'Cái','balobonghinhdoraemon', '4', '1')," +
                " ('Bút chì gỗ họa tiết 2B Unicorn', 321, 4000, 'Cây', 'butchigohoatiet2bunicorn','4', '1')," +
                " ('Sổ bìa da kẻ ngang 180 trang 80 gsm - TheSun', 30, 75000, 'Cuốn', 'sobiada180trang','4', '1')," +
                " ('Bóp Viết Eva Avengers Blue', 12, 145000, 'Cái', 'bopvietevaavenger','4', '1')," +
                " ('Máy Tính Casio FX 580 VN X', 12, 719000, 'Cái', 'maytinhCasio','4', '1');";
        String nhapSp5 = "INSERT INTO tbsanpham ( TENSP, LUONGTON, DONGIA, DVT,ANH,  MALOAISP, MAKHO) VALUES" +
                " ('Lớp học mật ngữ: Cuộc đua sao chổi', 40, 440000, 'Bộ', 'lophocmatngu','5', '1')," +
                " ('Đồ Chơi Lắp Ráp Mô Hình SD Gundam World Heroes No.03', 406, 183000, 'Bộ','dochoilaprapgundam', '5', '1')," +
                " ('Bộ Cờ Chiến Thuật SD Gundam World Heroes Ver 1 ', 780, 119000, 'Bộ', 'bocochienthuatgundam','5', '1')," +
                " ('Thẻ Bài Ma Sói Character Việt Hóa', 360, 123000, 'Bộ', 'thebaimasoi','5', '1')," +
                " ('Rubik 3x3 FanXin 581', 901, 35000, 'Bộ','rubik', '5', '1')," +
                " ('Đồ Chơi Con Sâu 3D', 1540, 92000, 'Bộ','dochoiconsau3d', '5', '1');";
