...
public class NV_QT2_DongGoiDH_Activity extends AppCompatActivity {
    ListView danhsach;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dong_goi_dh);
        ...
        danhsach.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent acti = new Intent(NV_QT2_DongGoiDH_Activity.this, NV_DuyetDonHang.class);
                ...
                startActivity(acti);
                Toast.makeText(NV_QT2_DongGoiDH_Activity.this, "Thong tin: " + list.get(i).getMadh().toString(),Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
    protected void onResume() {
        ...
        super.onResume();
        DonHang_HoaDon_DAO hddao = new DonHang_HoaDon_DAO(this);
        ArrayList<DonHang_HoaDon> update = (ArrayList<DonHang_HoaDon>) hddao.getAll_QT2();
